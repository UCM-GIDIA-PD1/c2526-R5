"""
Random Search — Búsqueda aleatoria de hiperparámetros para LightGBM global

Predice target_delay_30m usando el dataset mensual completo (todas las líneas).
...
if __name__ == "__main__":
    ...
    print(f"Lanzando {NUM_RUNS} trials random search (target={TARGET})...\n")
