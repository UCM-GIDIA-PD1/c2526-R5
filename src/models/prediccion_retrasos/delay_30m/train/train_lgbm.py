...
Uso:
    uv run python -m src.models.prediccion_retrasos.delay_30m.train.train_lgbm
...
def add_target_encoding(df_train: pd.DataFrame, df_val: pd.DataFrame,
    ...
    """Target encoding: media del target por categoría (train→val con fallback a media global)."""
