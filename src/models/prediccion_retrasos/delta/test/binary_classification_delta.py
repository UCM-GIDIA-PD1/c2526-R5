...
Uso:
    uv run python src/models/prediccion_retrasos/delay_10m/binary_classification_delta.py
...
TARGET_DELTA  = "delta_delay_30m"   # cambiar para otro horizonte: _20m, _30m, _45m, _60m, etc.
