...
Uso:
  python -m src.models.modelos_alertas.Random.RegresionLogistica_alertas_random
"""
...
def main():
    ...
    pipeline_final = build_pipeline(NUM_FEATURES, C=mejores_params["C"], class_weight=mejores_params["class_weight"])
