...
A continuación, va la búsqueda de hiperparámetros con Optuna .
...
def main():
    ...
    modelo_con = RandomForestClassifier(**best_params)
    ...
    modelo_sin = RandomForestClassifier(**best_params)
    ...
    print(f"\n{'='*60}")
    print("RESUMEN - RF por linea (Optuna)")
    print(f"{'='*60}")
