...
#Cambios varios en las columnas para su uso posterior
df["borough"] = df["event_borough"]
df = df[['event_name', 'event_type', 'start_date_time', 'end_date_time', 'event_location', 'borough', 'community_board']]
...
#Mapa para clasificar los eventos dependiendo del impacto que pueden llegar a tener
riesgo_map = {
        'Parade': 10,
