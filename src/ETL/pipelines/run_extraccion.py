...
Uso:
  uv run python src/ETL/pipelines/run_extraccion --source all --start 2025-02-01 --end 2025-02-07
  uv run python src/ETL/pipelines/run_extraccion --source clima --start 2025-02-01 --end 2025-02-07
"""
