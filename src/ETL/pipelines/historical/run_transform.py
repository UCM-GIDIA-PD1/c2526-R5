...
Uso:
  uv run python src/ETL/pipelines/historical/run_transform.py --source gtfs_historico --start 2025-12-01 --end 2025-12-31
  uv run python src/ETL/pipelines/historical/run_transform.py --source clima --start 2025-01-01 --end 2025-12-31
"""
